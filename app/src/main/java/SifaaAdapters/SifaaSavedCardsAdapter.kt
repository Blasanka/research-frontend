...
class SifaaSavedCardsAdapter(
    val context: Context,
    private val itemSifaas: ArrayList<SifaaSavedCardItem>,
    private val amountToPay: Float,
    private val listener: OnItemClickListener
): RecyclerView.Adapter<SifaaSavedCardsAdapter.ItemListViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemListViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.sifaa_card_save_item, parent, false)
        return ItemListViewHolder(itemView)
    }

    override fun onBindViewHolder(holder: ItemListViewHolder, position: Int) {
        val currentItem = itemSifaas[position]
    ...
    override fun getItemCount(): Int = itemSifaas.size
}