...
class SifaaOrderItemAdapter(var context: Context,
                            ...
                            private val listener: OnItemClickListener
                               ) : RecyclerView.Adapter<SifaaOrderItemAdapter.ItemListViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemListViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.list_cart_item, parent, false)
        return ItemListViewHolder(itemView)
    }

    override fun onBindViewHolder(holder: ItemListViewHolder, position: Int) {
        val currentItem = itemOrderedListSifaa[position]
    ...
    private fun removeItem(position: Int) {
        itemOrderedListSifaa.removeAt(position)
    ...
    override fun getItemCount(): Int = itemOrderedListSifaa.size
