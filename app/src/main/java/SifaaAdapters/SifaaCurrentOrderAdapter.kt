...
class SifaaCurrentOrderAdapter(
    var context: Context,
    private var sifaaCurrentOrderList: ArrayList<SifaaCurrentOrderItem>,
    private val listener: OnItemClickListener
) :
    RecyclerView.Adapter<SifaaCurrentOrderAdapter.ItemListViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemListViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(
            R.layout.sifaa_current_order_item,
            parent,
            false
        )
    ...
    override fun onBindViewHolder(holder: ItemListViewHolder, position: Int) {
        ...
        val currentItem = sifaaCurrentOrderList[position]
    ...
    private fun addTable(sifaaCurrentOrderItem: SifaaCurrentOrderItem, table: TableLayout) {

        val items = sifaaCurrentOrderItem.orderItemNames.split(";")
        val qtys = sifaaCurrentOrderItem.orderItemQuantities.split(";")
    ...
    override fun getItemCount(): Int = sifaaCurrentOrderList.size
