...
class SifaaOrderDoneActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.sifaa_activity_order_done)
    ...
    private fun saveOrderRecordToDatabase() {
        val item = SifaaOrderHistoryItem(orderDate, orderID, "Order Successful", paymentMethod, "\$%.2f".format(subTotalPrice))
